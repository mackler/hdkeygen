...
// from https://gist.github.com/markov/5206312
 
/**
 * <p>Provides Base32 encoding and decoding as defined by
 * <a href="http://www.ietf.org/rfc/rfc4648.txt">RFC 4648</a>.
 * However it uses a custom alphabet first coined by Douglas Crockford.
 * Only addition to the alphabet is that 'u' and 'U' characters decode as if
 * they were 'V' to improve mistakes by human input.<p/>
 * <p>
 ...
 * @see <a href="http://www.crockford.com/wrmg/base32.html">Douglas Crockford's
 * Base32 Encoding</a>
 * @since 1.5
 */
